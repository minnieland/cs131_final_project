...
4. **Alert System:** Speaker generates audio alerts when unsafe driving behavior is detected.
...
6. **Cloud Infrastructure:** Amazon Web Services. Store unsafe driving behavior events/logs.
...
**Quality Attributes:**
1. **Security:** HTTPS encrypted communication, restricted dashboard access
